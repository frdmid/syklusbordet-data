# ---------------------------------------------------------------------------
# sonde_kjor_stockanalysis: knekk stockanalysis.com, eller slaa fast at den
# ikke lar seg knekke
#
...
#
# Kjores av sonde_ad_hoc.py, som finner alle sonde_kjor_*.py. Utskriften
# havner i sonder/sonde_kjor_stockanalysis.txt med navn og tidspunkt oeverst.
# ---------------------------------------------------------------------------
